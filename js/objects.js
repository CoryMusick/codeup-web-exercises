(function() {
    ...
    for(let i = 0; i < shoppers.length; i++){
        console.log('Shoppers name = ' + shoppers[i].name);
        if (shoppers[i].amount > 200){
            console.log(shoppers[i].name + "'s total is $" + shoppers[i].amount + " they get a 12% discount " +
                "this makes their new total $" + (shoppers[i].amount * .88).toFixed(2))
        }else{
            console.log(shoppers[i].name + "'s total is $" + shoppers[i].amount + " they do not qualify for a discount")
        }
    }
